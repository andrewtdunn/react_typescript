...
import { Task, TasksDocument, TasksQuery, TasksQueryVariables, TaskStatus, useTasksQuery } from '../generated/graphql-frontend';
...
export const getServerSideProps: GetServerSideProps = async ( context ) => {
  const status = 
    typeof context.params?.status === 'string' ? context.params.status : undefined;
